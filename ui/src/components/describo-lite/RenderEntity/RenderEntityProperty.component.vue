<template>
    <div class="flex flex-row flex-grow">
        {{ props.property }} {{ props.entity[props.property] }}
        {{ props.profile }}
...
function getProfileDefinitionForProperty() {
    let entityDefinition = props.profile.classes[props.entity["@type"]];
    let propertyDefinition = entityDefinition.inputs.filter((p) => p.name === props.property);
